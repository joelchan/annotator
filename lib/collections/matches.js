...
MatchManager = (function() {
    return {
        ...
        updateMatches: function(user, currentDoc) {
          Meteor.call("getPossible", user, currentDoc, function(err, possibleMatches) {
            if (possibleMatches) {
          ...
          Meteor.call("getBest", user, currentDoc, function(err, bestMatches) {
            if (bestMatches) {
          ...
          // var lastMatchSet = Session.get("lastMatchSet").matches;
          var newMatchSet = [];
          var ranks = {};
          var rank = 1;
          ...
          logger.debug("Updating matching docs");
