...
EventLogger = (function () {
  return {
    ...
    ******************************************************************/
    ...
    logBeginScaffold: function(docID) {
      var msg = "User began scaffolded summary of document";
      var data = {"docID": docID}
      this.log(msg, data);
    },
    logEndScaffold: function(docID) {
      var msg = "User finished scaffolded summary of document";
      var data = {"docID": docID}
      this.log(msg, data);
    },
