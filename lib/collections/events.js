...
EventLogger = (function () {
  return {
    ...
    ******************************************************************/
    ...
    logUpdateSearch: function(query) {
      var msg = "Search resuts updated after user action";
      var data = {'seedDoc': Session.get("currentDoc"),
                  'query': query,
                  'matches': Session.get("lastMatchSet").ranks}
      this.log(msg, data);
    ...
    logRedoSearch: function(query, search) {
      ...
      var data = {'search': search, 'query': query}
      this.log(msg, data);
    },
    ...
    logImplicitReject: function(query, matchingDoc, rank) {
      ...
      var data = {'seedDoc': Session.get("currentDoc"),
                  ...
                  'matchingDoc': matchingDoc,
                  'rank': rank,
                  'otherMatches': Session.get("lastMatchSet").ranks}
      this.log(msg, data);
    },
